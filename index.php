...
<div class="servico_section">
        <div class="servicos"> 
            ...
            <h1>VACINAÇÃO</h1>
            <p>Imunização veterinária, pet filhote<br>
            e adultos.</p>
            <div class="btn_servico">        
        <a href="https://api.whatsapp.com/send/?phone=5511951934537&text&type=phone_number&app_absent=0" id="btn_servico" type="button">ENVIE SUA MENSAGEM</a>        
        </div>
        </div>
        <div class="servicos">
                <div class="img_servico">
        ...
        <div class="servicos">
            ...
            <h1>EUTANÁSIAS</h1>
            <p>Procedimento de eutanásia<br>
             de cães e gatos.</p>
            <div class="btn_servico">        
        <a href="https://api.whatsapp.com/send/?phone=5511951934537&text&type=phone_number&app_absent=0" id="btn_servico" type="button">ENVIE SUA MENSAGEM</a>        
        </div>
...
<div class="banner_contato">
    ...
    <div class="atendimento">
         ...
         <div class="p_atendimento">
         <p>Este é o local da nossa clinica veterinaria<br>
        venha conhecer nosso ambiente.</p>
        </div>
<div class="local">
